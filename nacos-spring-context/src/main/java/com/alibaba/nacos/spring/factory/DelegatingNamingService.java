...
class DelegatingNamingService
    ...
    @Override
    public void subscribe(String serviceName, NamingSelector namingSelector, EventListener eventListener) throws NacosException {
        delegate.subscribe(serviceName, namingSelector, eventListener);
    }

    @Override
    public void subscribe(String serviceName, String groupName, NamingSelector namingSelector,
                          EventListener eventListener) throws NacosException {
        delegate.subscribe(serviceName, groupName, namingSelector, eventListener);
    }
